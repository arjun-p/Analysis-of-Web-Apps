...
public class add_new_user {
  ...
  public void testAddNewUser() throws Exception {
    ...
    driver.findElement(By.name("user_login")).sendKeys("arjun");
    driver.findElement(By.name("user_password")).clear();
    driver.findElement(By.name("user_password")).sendKeys("arjun");
    driver.findElement(By.name("name")).clear();
    driver.findElement(By.name("name")).sendKeys("arjun");
    driver.findElement(By.name("email")).clear();
    driver.findElement(By.name("email")).sendKeys("arjun@gmail.com");
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    assertEquals("arjun", driver.findElement(By.xpath("//tr[4]/td/a/font")).getText());
