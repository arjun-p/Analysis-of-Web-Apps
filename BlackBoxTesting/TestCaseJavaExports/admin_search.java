...
public class admin_search {
  ...
  public void testAdminSearch() throws Exception {
    ...
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    assertEquals("CodeCharge Presentation ", driver.findElement(By.xpath("//td[2]/font")).getText());
    new Select(driver.findElement(By.name("approved"))).selectByVisibleText("No");
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    new Select(driver.findElement(By.name("approved"))).selectByVisibleText("");
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    new Select(driver.findElement(By.name("approved"))).selectByVisibleText("Yes");
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    assertEquals("Yes ", driver.findElement(By.xpath("//td[5]/font")).getText());
    driver.findElement(By.xpath("//td[4]/a/font/img")).click();
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
  }
