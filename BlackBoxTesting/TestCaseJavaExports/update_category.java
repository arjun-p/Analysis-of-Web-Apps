...
public class update_category {
  ...
  public void testUpdateCategory() throws Exception {
    ...
    driver.findElement(By.name("category_desc")).sendKeys("Science1");
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    assertEquals("Science1", driver.findElement(By.xpath("//tr[6]/td/a/font")).getText());
    driver.findElement(By.xpath("//tr[6]/td/a/font")).click();
    driver.findElement(By.name("category_desc")).clear();
    driver.findElement(By.name("category_desc")).sendKeys("Science");
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    driver.findElement(By.xpath("//td[4]/a/font/img")).click();
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
