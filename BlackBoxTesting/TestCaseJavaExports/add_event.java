...
public class add_event {
  ...
  public void testAddEvent() throws Exception {
    ...
    driver.findElement(By.name("name")).sendKeys("SampleEvent");
    ...
    driver.findElement(By.name("presenter")).sendKeys("Arjun");
    driver.findElement(By.name("approved")).click();
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    driver.findElement(By.name("name")).clear();
    driver.findElement(By.name("name")).sendKeys("SampleEvent");
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    assertEquals("SampleEvent ", driver.findElement(By.xpath("//td[2]/font")).getText());
    driver.findElement(By.xpath("//tr[2]/td/a/font")).click();
