  ...
  <tr>
   ...
   <td valign="top">
    <table border="0" cellspacing="2" cellpadding="0" border=1>
     ...
     <tr>
      <td bgcolor="#FFDD00"><font style="font-size: 10pt; color: #000000; font-family: Arial, Tahoma, Verdana, Helvetica">Login</font></td><td ><input type="text" name="Login" maxlength="50" value="1.0"></td>
     </tr>
     <tr>
     ...
     <tr>
      <td colspan="2"><input type="hidden" name="FormAction" value="login"><input type="submit" value="Login"><input type="hidden" name="ret_page" value=""><input type="hidden" name="querystring" value=""></td>
     </form>
     </tr>
    </table>
