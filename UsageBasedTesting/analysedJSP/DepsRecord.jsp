  ...
  <tr>
   ...
   <td valign="top">
    <table border="0" cellspacing="2" cellpadding="0">
     ...
     <form method="get" action="DepsRecord.jsp" name="deps">
     <tr>
      <td bgcolor="#FFDD00"><font style="font-size: 10pt; color: #000000; font-family: Arial, Tahoma, Verdana, Helvetica">Name</font></td><td ><input type="text"  name="name" maxlength="50" value="Administration" size="50"></td>
     </tr>
     <tr>
      <td colspan="2" align="right"><input type="submit" value="Update" onclick="document.deps.FormAction.value = 'update';"><input type="submit" value="Delete" onclick="document.deps.FormAction.value = 'delete';"><input type="submit" value="Cancel" onclick="document.deps.FormAction.value = 'cancel';"><input type="hidden" name="FormName" value="deps"><input type="hidden" value="update" name="FormAction"><input type="hidden" name="dep_id" value="2"><input type="hidden" name="PK_dep_id" value="2"/></td>
     </tr>
     </form>
    </table>
