  ...
  <tr>
   ...
   <td valign="top">
    <table border="0" cellspacing="2" cellpadding="0" border=1>
     ...
     <tr>
      <td colspan="2"><input type="hidden" name="FormAction" value="login"><input type="submit" value="Login"><input type="hidden" name="ret_page" value="/empldir/DepsGrid.jsp"><input type="hidden" name="querystring" value=""></td>
     </form>
     </tr>
    </table>
