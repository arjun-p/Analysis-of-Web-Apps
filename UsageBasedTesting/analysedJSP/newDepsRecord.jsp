  ...
  <tr>
   ...
   <td valign="top">
    <table border="0" cellspacing="2" cellpadding="0">
     ...
     <tr>
      <td bgcolor="#FFDD00"><font style="font-size: 10pt; color: #000000; font-family: Arial, Tahoma, Verdana, Helvetica">Name</font></td><td ><input type="text"  name="name" maxlength="50" value="" size="50"></td>
     </tr>
     <tr>
      <td colspan="2" align="right"><input type="submit" value="Insert" onclick="document.deps.FormAction.value = 'insert';"><input type="submit" value="Cancel" onclick="document.deps.FormAction.value = 'cancel';"><input type="hidden" name="FormName" value="deps"><input type="hidden" value="insert" name="FormAction"><input type="hidden" name="dep_id" value=""><input type="hidden" name="PK_dep_id" value=""/></td>
     </tr>
     </form>
    </table>
