...
public class DefaultNoRecords {
  ...
  @Test
  public void testDefaultNoRecords() throws Exception {
    ...
    assertEquals("No records", driver.findElement(By.xpath("//td[3]/table[3]/tbody/tr[2]/td/font")).getText());
    driver.findElement(By.xpath("//td[5]/a/font/img")).click();
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
  }
