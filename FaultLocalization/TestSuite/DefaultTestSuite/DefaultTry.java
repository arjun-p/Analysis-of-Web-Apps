...
public class DefaultTry {
  ...
  @Test
  public void testDefaultTry() throws Exception {
    driver.get(baseUrl + "/bkfl/Default.jsp");
    ...
    driver.findElement(By.name("name")).sendKeys("Flash 4 Ma");
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    driver.findElement(By.xpath("//td[2]/a/font/img")).click();
    ...
    driver.findElement(By.xpath("//tr[10]/td/a/font")).click();
    driver.findElement(By.xpath("//input[@value='Delete']")).click();
    ...
    driver.findElement(By.name("name")).clear();
    driver.findElement(By.name("name")).sendKeys("Flash 4 Magic");
    driver.findElement(By.cssSelector("input[type=\"submit\"]")).click();
    driver.findElement(By.xpath("//td[6]/a/font/img")).click();
    driver.findElement(By.xpath("//td[6]/a/font/img")).click();
    driver.findElement(By.xpath("//td[5]/a/font/img")).click();
